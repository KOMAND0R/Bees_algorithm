...
class dejongbee(pybee.floatbee):
    ...
    def __init__(self):
        ...
        self.position = [random.uniform(self.minval[n], self.maxval[n]) for n in xrange(dejongbee.count)]
        self.calcfitness()
...
class goldsteinbee(pybee.floatbee):
    ...
    def __init__(self):
        ...
        self.position = [random.uniform(self.minval[n], self.maxval[n]) for n in xrange(goldsteinbee.count)]
        self.calcfitness()
...
class rosenbrockbee(pybee.floatbee):
    ...
    def __init__(self):
        ...
        self.position = [random.uniform(self.minval[n], self.maxval[n]) for n in xrange(rosenbrockbee.count)]
        self.calcfitness()
...
class testbee(pybee.floatbee):
    ...
    def __init__(self):
        ...
        self.position = [random.uniform(self.minval[n], self.maxval[n]) for n in xrange(testbee.count)]
        self.calcfitness()
...
class funcbee(pybee.floatbee):
    ...
    def __init__(self):
        ...
        self.x1_points = [random.uniform(xmin, xmax) for n in xrange(self.xcount)]
        self.x2_points = [random.uniform(xmin, xmax) for n in xrange(self.xcount)]
        self.x3_points = [random.uniform(xmin, xmax) for n in xrange(self.xcount)]
        self.x4_points = [random.uniform(xmin, xmax) for n in xrange(self.xcount)]
        ...
        self.correct_vals = [
            ...
            for n in xrange(self.xcount)]

        self.position = [random.uniform(self.minval[n], self.maxval[n]) for n in xrange(funcbee.count)]
        self.calcfitness()
